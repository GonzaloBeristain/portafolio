...
export const Footer = () => {
    return (
        <div className="h-20 bg-slate-950 flex items-center border-t justify-center border-slate-800 md:justify-around">
            ...
            <section className="text-white flex gap-x-2">
                {/* Linkedin */}
                <Link href={"https://www.linkedin.com/in/gonzalo-beristain"} className="hover:text-blue-600 transition-colors duration-300"> 
                ...
                {/* Github */}
                <Link href={"https://github.com/GonzaloBeristain"} className="hover:text-purple-600 transition-colors duration-300"> 
                    <svg width="2rem" height="2rem" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"> 

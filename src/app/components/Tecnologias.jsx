        ...
        <div id="tecnologias" className="flex flex-col justify-center container mx-auto px-4 pb-5 md:w-1/2 md:px-2 md:pb-96 md:pt-40 md:h-[calc(100vh-rem)]">
            ...
            <section className="shadow rounded-lg bg-slate-500 pb-5 flex justify-center items-center">
                <ul className="grid grid-cols-2 gap-y-3 gap-x-3 pl-4 pt-5 md:grid-cols-4 md:gap-y-10 md:pl-10">
                    ...
                    <li className="flex text-white font-semibold items-center justify-start"><Image src="/images/logos/JavaScript.png" alt="foto" className="mx-2 hover:scale-150 transition-transform duration-300" width={40} height={40} />JavaScript</li>
                    ...
                    <li className="flex text-white font-semibold items-center justify-start"><Image src="/images/logos/Mysql.png" alt="foto" className="mx-2 hover:scale-150 transition-transform duration-300" width={40} height={40} />MySQL</li>
                    <li className="flex text-white font-semibold items-center justify-start"><Image src="/images/logos/Typescript.png" alt="foto" className="mx-2 hover:scale-150 transition-transform duration-300" width={40} height={40} />TypeScript</li>
                    ...
                    <li className="flex text-white font-semibold items-center justify-start"><Image src="/images/logos/EntityFramework.png" alt="foto" className="mx-2 hover:scale-150 transition-transform duration-300" width={40} height={40} />Entity Framework</li>
                    ...
                    <li className="flex text-white font-semibold items-center justify-start"><Image src="/images/logos/PS.png" alt="foto" className="mx-2 hover:scale-150 transition-transform duration-300" width={40} height={40} />Photoshop</li>

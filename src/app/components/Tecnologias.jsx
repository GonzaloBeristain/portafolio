        ...
        <div id="tecnologias" className="flex flex-col justify-center container mx-auto px-4 md:pt-20 xl:w-1/2 xl:px-2 xl:pt-24 xl:h-[calc(100vh-rem)]">
            ...
            <section className="shadow rounded-lg bg-slate-500 pb-5 flex justify-center items-center">
                <ul className="grid grid-cols-2 gap-y-3 gap-x-3 pl-4 pt-5 md:grid-cols-4 md:gap-y-10 md:pl-10">
                    ...
                    <li className="flex text-white font-semibold items-center justify-start"><Image src="/images/logos/Python.png" alt="foto" className="mx-2 hover:scale-150 transition-transform duration-300" width={40} height={40} />Python</li>
                    ...
                    <li className="flex text-white font-semibold items-center justify-start"><Image src="/images/logos/Django.png" alt="foto" className="mx-2 hover:scale-150 transition-transform duration-300" width={40} height={40} />Django</li>
